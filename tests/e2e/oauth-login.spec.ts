...
test.describe('OAuth Login Flow', () => {
  test('should display login form at authorization endpoint', async ({ page }) => {
    ...
    await page.goto('http://localhost:3000/oauth/authorize?client_id=test-client&redirect_uri=http://localhost:3000/callback&response_type=code&state=test-state');
