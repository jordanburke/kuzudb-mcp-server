...
test.describe('OAuth Complete Flow - Login to MCP Access', () => {
  test('should complete full OAuth login and access MCP resources', async ({ page, request, context }) => {
    ...
    await page.goto('http://localhost:3000/oauth/authorize?response_type=code&client_id=test-client&redirect_uri=http://localhost:3000/callback&state=test-state-123');
